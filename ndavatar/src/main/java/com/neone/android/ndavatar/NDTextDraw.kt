...
class NDTextDraw private constructor(builder: Builder): ShapeDrawable(builder.shape) {
    ...
    class Builder() : IConfigBuilder,
        ...
        override fun buildRect(text: String?, color: Int): NDTextDraw? {
            rect()
            return build(text, color)
        }

        override fun buildRoundRect(text: String?, color: Int, radius: Int): NDTextDraw? {
            roundRect(radius)
            return build(text, color)
        }

        override fun buildRound(text: String?, color: Int): NDTextDraw? {
            round()
            return build(text, color)
        }

        override fun build(text: String?, color: Int): NDTextDraw? {
            this.color = color
            this.text = text ?: ""
            return NDTextDraw(this)
        }
    ...
    interface IBuilder {
        fun build(text: String?, color: Int): NDTextDraw?
    }
    ...
    interface IShapeBuilder {
        ...
        fun buildRect(text: String?, color: Int): NDTextDraw?
        fun buildRoundRect(text: String?, color: Int, radius: Int): NDTextDraw?
        fun buildRound(text: String?, color: Int): NDTextDraw?
    }
